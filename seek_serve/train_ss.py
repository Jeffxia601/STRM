...
def main():
    ...
    x_train, y_train = pickle.load(open('dataset/train_seek_and_serve_pad_07_2000_2020.pkl', 'rb'))
    ...
    history = model_fit(
        ...
        save_path=f'new_models/{model_type}_model_{model_tag}_seek_serve_pretrain_{pretrain_tag}_{number_tag}.pt' if pretrain_tag is not None else f'new_models/{model_type}_model_{model_tag}_seek_serve_{number_tag}.pt',
    ...
    model = torch.load(f'new_models/{model_type}_model_{model_tag}_seek_serve_pretrain_{pretrain_tag}_{number_tag}.pt' if pretrain_tag is not None else f'new_models/{model_type}_model_{model_tag}_seek_serve_{number_tag}.pt')
    # Evaluate model
    ...
    if pretrain_tag is not None:
        loss_path = f"new_loss/{model_type}_model_{model_tag}_seek_serve_{pretrain_tag}_{number_tag}.pkl"
    else:
        loss_path = f"new_loss/{model_type}_model_{model_tag}_seek_serve_{number_tag}.pkl"
    ...
    if pretrain_tag is not None:
        plt.savefig(f'new_figure/{model_type}_model_{model_tag}_seek_serve_{pretrain_tag}_{number_tag}_07_2000_2020.png')
    else:
        plt.savefig(f'new_figure/{model_type}_model_{model_tag}_seek_serve_{number_tag}_07_2000_2020.png')
